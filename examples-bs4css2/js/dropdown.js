define([
  ...
  "./popper",
  "./util"
],function(langx,browser,eventer,noder,geom,$,bs4,Popper,Util){
  'use strict';
  ...
  function () {
    ...
    _proto.toggle = function toggle() {
      ...
      var showEvent = eventer.create(Event.SHOW, relatedTarget);
    ...
    _proto.hide = function hide() {
      ...
      var hideEvent = eventer.create(Event.HIDE, relatedTarget);
